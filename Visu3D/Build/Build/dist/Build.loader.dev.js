...
function createUnityInstance(e, t, r) {
  function n(e) {
    var t = "unhandledrejection" == e.type && "object" == _typeof(e.reason) ? e.reason : "object" == _typeof(e.error) ? e.error : null,
  ...
  function s(e, t) {
    if ("symbolsUrl" != e) {
      ...
      n || (n = l.downloadProgress[e] = {
        ...
        total: 0,
        loaded: 0
      }), "object" != _typeof(t) || "progress" != t.type && "load" != t.type || (n.started || (n.started = !0, n.lengthComputable = t.lengthComputable, n.total = t.total), n.loaded = t.loaded, "load" == t.type && (n.finished = !0));
      var o = 0,
          a = 0,
          s = 0,
          i = 0,
  ...
  var l = {
    ...
    cacheControl: function cacheControl(e) {
    ...
    locateFile: function locateFile(e) {
  ...
  return l.SystemInfo = function () {
    ...
    var p = "undefined" != typeof SharedArrayBuffer,
        h = "object" == (typeof WebAssembly === "undefined" ? "undefined" : _typeof(WebAssembly)) && "function" == typeof WebAssembly.compile;
    return {
      width: screen.width,
